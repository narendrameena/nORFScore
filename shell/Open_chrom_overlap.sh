...
ls -lrth ../../../data/encode/DNA_methaylation_hg38/ |grep 'bed.gz'| awk '{split($9,a,".bed"); print a[1]}' | grep -v  'meta' |  grep -v '^[[:space:]]' | xargs -n 2  -P 80 sh -c 'zcat  ../../../data/encode/DNA_methaylation_hg38/$0.bed.gz |sort -T /mnt/hdd2/narendra/tmp -k 1,1 -k2,2n > ../../../data/encode/DNA_methaylation_hg38/$0_sort.bed.gz ;zcat  ../../../data/encode/DNA_methaylation_hg38/$1.bed.gz | sort -T /mnt/hdd2/narendra/tmp -k 1,1 -k2,2n > ../../../data/encode/DNA_methaylation_hg38/$1_sort.bed.gz ;bedtools closest  -a ../../../data/input/nORF/nORFsFromMatt/all_38.6.bed.gz -b ../../../data/encode/DNA_methaylation_hg38/$0_sort.bed.gz ../../../data/encode/DNA_methaylation_hg38/$1_sort.bed.gz -names $0 $1  -D a -t all -k 10  > $0_$1_closest.bed;rm ../../../data/encode/DNA_methaylation_hg38/$0_sort.bed.gz;rm ../../../data/encode/DNA_methaylation_hg38/$1_sort.bed.gz;gzip $0_$1_closest.bed'
